{{-- Footer Component --}}
<footer class="py-16 text-gray-300 bg-gray-900">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-8 mb-8 md:grid-cols-4">
            <div>
                <div class="flex items-center mb-4">
                    @if(site_logo())
                        <img src="{{ site_logo() }}" alt="{{ site_name() }}" class="w-auto h-8 brightness-0 invert">
                    @else
                        ...
                        <span class="ml-2 text-xl font-bold text-white">{{ site_name() }}</span>
                    @endif
                </div>
                <p class="mb-4">Call us</p>
                <p class="mb-2 font-semibold text-white">+62 812 7606 351</p>
                <p class="text-sm">Bengkalis - Riau<br>Indonesia</p>
            </div>
        ...
        <div class="flex flex-col justify-between items-center pt-8 border-t border-gray-800 md:flex-row">
