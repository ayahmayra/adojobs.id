            ...
            <div class="px-4 py-8 mx-auto max-w-4xl">
                <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">info@adojobs.id</p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-medium text-gray-900">08:00 - 12:00 WIB</span>
                                </div>
                                <div class="flex justify-between items-center">
                        ...
                        <div class="bg-indigo-50 rounded-lg p-6">
                            <h3 class="text-lg font-semibold text-indigo-900 mb-3">Butuh Bantuan Cepat?</h3>
                ...
                <div class="mt-12 text-center">
                    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-8 text-white">
                        <h3 class="text-2xl font-bold mb-4">Siap Memulai Karier Anda?</h3>
                        <p class="text-lg mb-6 text-indigo-100">
                            Daftar sekarang dan temukan lowongan kerja terbaik di Pulau Bengkalis
                        </p>
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="{{ route('register') }}" 
                               class="inline-flex items-center px-6 py-3 text-base font-medium text-indigo-600 bg-white rounded-lg hover:bg-gray-50 transition-colors">
                                Daftar Sekarang
                            </a>
                            <a href="{{ route('jobs.index') }}" 
                               class="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-transparent border border-white rounded-lg hover:bg-white hover:text-indigo-600 transition-colors">
                                Lihat Lowongan
                            </a>
                        </div>
                    </div>
                ...
                <div class="mt-8 text-center">
                    <a href="{{ route('home') }}" 
                       class="inline-flex items-center px-6 py-3 text-base font-medium text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
                        Kembali ke Beranda
                    </a>
                </div>
            </div>
