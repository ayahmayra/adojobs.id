...
<div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="p-6 bg-white rounded-lg shadow">
            ...
            <div class="mt-4">
                <button class="px-4 py-2 text-sm font-medium text-indigo-600 bg-indigo-50 rounded-lg transition hover:bg-indigo-100">
                    Edit Pengaturan
                </button>
            </div>
        </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow">
            ...
            <div class="mt-4">
                <button class="px-4 py-2 text-sm font-medium text-green-600 bg-green-50 rounded-lg transition hover:bg-green-100">
                    Konfigurasi Email
                </button>
            </div>
        </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow">
            ...
            <div class="mt-4">
                <button class="px-4 py-2 text-sm font-medium text-purple-600 bg-purple-50 rounded-lg transition hover:bg-purple-100">
                    Edit SEO
                </button>
            </div>
        </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow">
            <div class="flex items-center mb-4">
                <div class="flex justify-center items-center w-12 h-12 text-red-600 bg-red-100 rounded-lg">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-4">
                <button class="px-4 py-2 text-sm font-medium text-red-600 bg-red-50 rounded-lg transition hover:bg-red-100">
        ...
        <div class="p-6 bg-white rounded-lg shadow">
            <div class="flex items-center mb-4">
                <div class="flex justify-center items-center w-12 h-12 text-yellow-600 bg-yellow-100 rounded-lg">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-4">
                <button class="px-4 py-2 text-sm font-medium text-yellow-600 bg-yellow-50 rounded-lg transition hover:bg-yellow-100">
                    Kelola Notifikasi
                </button>
            </div>
        </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow">
            <div class="flex items-center mb-4">
                <div class="flex justify-center items-center w-12 h-12 text-blue-600 bg-blue-100 rounded-lg">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-4">
                <button class="px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg transition hover:bg-blue-100">
                    Kelola Sistem
                </button>
            </div>
        </div>
    ...
    <!-- Coming Soon Notice -->
    <div class="p-6 mt-8 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg border border-indigo-200">
